"""
Django settings for falling_scene_41995 project.
...
ROOT_URLCONF = 'falling_scene_41995.urls'
...
WSGI_APPLICATION = 'falling_scene_41995.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_scene_41995 API",
    "DESCRIPTION": "API documentation for falling_scene_41995 App",
    "VERSION": "v1",
}
